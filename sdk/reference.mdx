...
Merge configuration into the widget. Use it to set the user, change visibility, move the widget, or open the menu.
...
| `user` | `object` | User information. See [Identifying users](/sdk/identifying-users). |
