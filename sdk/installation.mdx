...
By default the widget shows on every page. Next, [tell Obi who the user is](/sdk/identifying-users), and decide [when to show it](/sdk/sessions#start-obi-after-login).
