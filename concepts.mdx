...
<ResponseField name="Context" type="object">
  Extra information about an onboardee that helps Obi personalize sessions. You can set context two ways: client-side through the SDK `user` object, or server-side through the [User Context API](/api-reference/introduction).
</ResponseField>
