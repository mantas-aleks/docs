...
<ResponseField name="Obi" type="agent">
  The Cor agent. Obi is the widget your users talk to. It guides them through onboarding and answers their questions. In code you will see it as `ObiSDK` and `obiWidgetConfig`.
</ResponseField>
